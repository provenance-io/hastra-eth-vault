...
SHARE CALCULATION (NAV Oracle)
  shares = assets * 1e18 / nav          (nav is 1e18-scaled rate from FeedVerifier)
  If oracle is not set or price is stale → reverts (no ERC-4626 ratio fallback)
```
...
├──────────────────────┼───────────────────────────┼─────────────────────────────────────┤
│ convertToShares()    │ return assets (hardcoded) │ NAV oracle: assets × 1e18 / nav; reverts if oracle unset or stale │
├──────────────────────┼───────────────────────────┼─────────────────────────────────────┤
