...
async function main() {
    ...
    // Initialize V2 - only runs once due to reinitializer(2); skip if already called
    ...
    try {
        ...
        console.log("ℹ️  initializeV2 skipped — already initialized (reinitializer already ran)");
    }
